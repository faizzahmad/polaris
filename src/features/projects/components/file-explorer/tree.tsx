...
import {
    useCreateFile, useCreateFolder,
    useFolderContents, useRenameFile, useDeleteFile
} from "../../hooks/use-file";
...
export const Tree = ({
    ...
    const handelRename = (newName: string) => {
        setIsRenaming(false);
    ...
    const handelCreate = (name: string) => {
         setCreating(null);
         if(creating === "file"){
